      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-6 max-w-md">
              Your gateway to endless stories and knowledge. Discover, read, and explore the world through literature.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 bg-dark-800 hover:bg-primary-600 rounded-full flex items-center justify-center transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#books" className="text-gray-400 hover:text-primary-400 transition-colors">Featured Books</a></li>
              <li><a href="#categories" className="text-gray-400 hover:text-primary-400 transition-colors">Categories</a></li>
        ...
        <div className="mt-12 pt-8 border-t border-dark-700">
          <div className="max-w-md">
            ...
            <p className="text-gray-400 mb-4">Get notified about new releases and exclusive content.</p>
            <div className="flex">
              <input
                type="email"
        ...
        <div className="mt-8 pt-8 border-t border-dark-700 text-center">
          <p className="text-gray-400">
            © 2024 Bibliora. All rights reserved. Made with ❤️ for book lovers.
          </p>
        </div>
      </div>
    </footer>
